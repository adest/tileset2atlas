...
TilesetExport_created_autogenerated_closure: {"": "Closure;this_0",
  call$1: function($$event) {
    ...
    t1 = this.this_0;
    $._enterScopeIfNeeded();
    t2 = $.get$window$x($._deserialize($._jsPortSync.callSync$1([])));
    t3 = $._activeObserver;
    if (t3 != null)
      t3._addRead$3(t1, 1, "jso");
    t2.prompt$2("Copy to clipboard: Ctrl+C, Enter", t1.get$__$jso());
  },
  "+call:1:0": 0,
  $isFunction: true
},
