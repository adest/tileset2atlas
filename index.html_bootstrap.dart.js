...
$$.BodyElement = {"": "_HTMLElement;",
  get$onLoad: function(receiver) {
    var t1 = new $._EventStream(receiver, $.EventStreamProvider_load._eventType, false);
    t1.$builtinTypeInfo = [null];
    return t1;
  },
  "@get$onLoad": function() {
    return [$.DomName_8aB, $.Type_cOY];
  },
  "+onLoad": 0
};
...
$$.CanvasRenderingContext2D = {"": ["CanvasRenderingContext;currentPath%,fillStyle%,font%,globalAlpha%,globalCompositeOperation%,lineCap%,lineJoin%,lineWidth%,miterLimit%,shadowBlur%,shadowColor%,shadowOffsetX%,shadowOffsetY%,strokeStyle%,textAlign%,textBaseline%,backingStorePixelRatio:webkitBackingStorePixelRatio=,imageSmoothingEnabled:webkitImageSmoothingEnabled%", function() {
  ...
  "@clearRect$4": function() {
    return [$.DomName_o2T, $.Type_cOY];
  },
  "+clearRect:4:0": 0,
  strokeRect$4: function(receiver, x, y, width, height) {
    return receiver.strokeRect(x, y, width, height);
  },
  "@strokeRect$4": function() {
    return [$.DomName_KPI, $.Type_cOY];
  },
  "+strokeRect:4:0": 0,
  ...
  "@drawImageScaledFromSource$9": function() {
    return [$.DomName_UkC, $.JSName_drawImage];
  },
...
$$.FileReader = {"": ["EventTarget;error=,readyState=,result=", function() {
  ...
  "@readAsDataUrl$1": function() {
    return [$.JSName_readAsDataURL, $.DomName_sk0, $.Type_cOY];
  },
  "+readAsDataUrl:1:0": 0,
  $$dom_removeEventListener$3: function(receiver, type, listener, useCapture) {
    return receiver.removeEventListener(type, $.convertDartClosureToJS(listener, 1), useCapture);
...
$$.MediaElement = {"": ["_HTMLElement;autoplay%,buffered=,controller%,controls%,currentSrc=,currentTime%,defaultMuted%,defaultPlaybackRate%,duration=,ended=,error=,initialTime=,loop%,mediaGroup%,mediaKeys%,muted%,networkState=,paused=,playbackRate%,played=,preload%,readyState=,seekable=,seeking=,src%,startTime=,textTracks=,volume%,audioDecodedByteCount:webkitAudioDecodedByteCount=,closedCaptionsVisible:webkitClosedCaptionsVisible%,hasClosedCaptions:webkitHasClosedCaptions=,preservesPitch:webkitPreservesPitch%,videoDecodedByteCount:webkitVideoDecodedByteCount=", function() {
    ...
    return [$.JSName_webkitClosedCaptionsVisible, $.DomName_8aB0, $.Type_cOY, $.SupportedBrowser_Chrome_null, $.SupportedBrowser_Safari_null, $.Type_0, $.Type_0];
  }, function() {
...
$$.Node = {"": ["EventTarget;_templateInstance%,$$dom_childNodes:childNodes=,$$dom_firstChild:firstChild=,$$dom_lastChild:lastChild=,$$dom_localName:localName=,$$dom_namespaceUri:namespaceURI=,nextNode:nextSibling=,nodeType=,nodeValue=,document:ownerDocument=,parent:parentElement=,parentNode=,previousNode:previousSibling=,text:textContent%", null, function() {
    ...
    return [$.JSName_nextSibling, $.DomName_Y6D3, $.Type_cOY];
  }, function() {
...
$$.ViewSpec = {"": ["Interceptor;preserveAspectRatio=,preserveAspectRatioString=,transform=,transformString=,viewBox=,viewBoxString=,viewTarget=,viewTargetString=,zoomAndPan%", function() {
    return [$.DomName_Wrl, $.Type_cOY, $.Type_0];
  }, function() {
    return [$.DomName_i0s, $.Type_cOY];
  }, function() {
    return [$.DomName_W8I, $.Type_cOY];
  }, function() {
    return [$.DomName_oSr, $.Type_cOY];
  }, function() {
    return [$.DomName_Y7l, $.Type_cOY, $.Type_0];
  }, function() {
    return [$.DomName_Djp0, $.Type_cOY];
  }, function() {
    return [$.DomName_Jea, $.Type_cOY];
  }, function() {
    return [$.DomName_Yqh, $.Type_cOY];
  }, function() {
    return [$.DomName_IMK1, $.Type_cOY, $.Type_0];
  }]};
...
_EventLoop: {"": "Object;events<,activeTimerCount@",
  dequeue$0: function() {
    var t1 = this.events;
    if ($.$eq(t1._liblib0$_head, t1._tail))
      return;
...
ListIterator: {"": "Object;_iterable<,_liblib2$_length<,_index@,_current@",
  get$current: function() {
...
TakeIterator: {"": "Iterator;_iterator<,_liblib2$_remaining@",
  moveNext$0: function() {
    ...
    if ($.$ge$n(this._liblib2$_remaining, 0) === true)
  ...
  "+moveNext:0:0": 0,
  get$current: function() {
    if ($.$lt$n(this._liblib2$_remaining, 0) === true)
      return;
    return this._iterator.get$current();
  },
  "+current": 0,
...
_ForwardingStream: {"": "Stream;_liblib5$_source<",
  listen$4$cancelOnError$onDone$onError: function(onData, cancelOnError, onDone, onError) {
    ...
    t4._subscription = t4._stream._liblib5$_source.listen$3$onDone$onError(t1, t4.get$_handleDone(), t2);
    return t4;
  },
  "+listen:1:3": 0,
...
_asyncRunCallback: function() {
  ...
  for (; t1 = $.get$_asyncCallbacks(), !$.$eq(t1._liblib0$_head, t1._tail);) {
...
ListQueue: {"": "IterableBase;_table@,_liblib0$_head@,_tail@,_modificationCount@",
  get$iterator: function(_) {
    return new $._ListQueueIterator(this, this._tail, this._modificationCount, this._liblib0$_head, null);
  },
  "+iterator": 0,
  forEach$1: function(_, action) {
  ...
  get$isEmpty: function(_) {
    return $.$eq(this._liblib0$_head, this._tail);
  },
  "+isEmpty": 0,
  get$length: function(_) {
    return $.$and$n($.$sub$n(this._tail, this._liblib0$_head), this._table.length - 1);
  },
  "+length": 0,
  elementAt$1: function(_, index) {
    var t1, t2;
    t1 = $.getInterceptor$n(index);
    if (t1.$lt(index, 0) === true || t1.$gt(index, $.$and$n($.$sub$n(this._tail, this._liblib0$_head), this._table.length - 1)) === true) {
      t1 = $.$and$n($.$sub$n(this._tail, this._liblib0$_head), this._table.length - 1);
      throw $.wrapException(new $.RangeError("value " + $.S(index) + " not in range 0.." + $.S(t1)));
    }
    t1 = this._table;
    t2 = $.$and$n($.$add$ns(this._liblib0$_head, index), this._table.length - 1);
  ...
  toList$1$growable: function(_, growable) {
    ...
    if (growable) {
      ...
      $.JSArray_methods.set$length(list, $.$and$n($.$sub$n(this._tail, this._liblib0$_head), this._table.length - 1));
    } else {
      t1 = $.$and$n($.$sub$n(this._tail, this._liblib0$_head), this._table.length - 1);
      $arguments = this.$asListQueue;
      arguments0 = $.getRuntimeTypeInfo(this);
  ...
  addAll$1: function(_, elements) {
    ...
    if (typeof elements === "object" && elements !== null && (elements.constructor === Array || !!$.getInterceptor(elements).$isList)) {
      ...
      $length = $.$and$n($.$sub$n(this._tail, this._liblib0$_head), this._table.length - 1);
  ...
  clear$0: function(_) {
    var i, t1, t2, t3;
    if (!$.$eq(this._liblib0$_head, this._tail)) {
      i = this._liblib0$_head;
      if (i !== (i | 0))
  ...
  clear$0$bailout: function(state0, i) {
    switch (state0) {
      ...
      case 1:
        var t1, t2;
        if (state0 === 1 || state0 === 0 && !$.$eq(this._liblib0$_head, this._tail))
          switch (state0) {
            case 0:
              i = this._liblib0$_head;
            case 1:
  ...
  removeFirst$0: function() {
    ...
    if (t2 >>> 0 !== t2 || t2 >= t1.length)
      throw $.ioore(t2);
    result = t1[t2];
    this._liblib0$_head = $.$and$n(t2 + 1, this._table.length - 1);
    return result;
  },
  "+removeFirst:0:0": 0,
    ...
    switch (state0) {
      ...
      case 4:
        ...
        if (state0 === 0 && $.$lt$n(startDistance, $.$and$n($.$sub$n(t1, offset), mask)) === true) {
          for (i = offset; t1 = $.getInterceptor(i), !t1.$eq(i, this._liblib0$_head); i = prevOffset) {
          ...
          if (t3 >>> 0 !== t3 || t3 >= t1.length)
            throw $.ioore(t3);
          t1[t3] = null;
          this._liblib0$_head = $.$and$n(t3 + 1, mask);
  ...
  _writeToList$1: function(target) {
    ...
    t1 = $.$le$n(this._liblib0$_head, this._tail);
    t2 = $.getInterceptor$ax(target);
    t3 = this._liblib0$_head;
    if (t1 === true) {
      $length = $.$sub$n(this._tail, t3);
      t2.setRange$4(target, 0, $length, this._table, this._liblib0$_head);
      return $length;
    } else {
      t1 = this._table;
      if (typeof t3 !== "number")
...
NoSuchMethodError: {"": "Object;_liblib4$_receiver<,_memberName<,_arguments<,_namedArguments<,_existingArgumentNames<",
  toString$0: function(_) {
    var t1, sb, t2, t3, t4;
    t1 = {};
    sb = new $.StringBuffer("");
...
Object: {"": ";",
  ...
  alert$1: function($receiver, $0) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("alert", "alert$1", 0, [$0], []));
  },
  ...
  readAsDataUrl$1: function($receiver, $0) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("readAsDataUrl", "readAsDataUrl$1", 0, [$0], []));
  },
  ...
  strokeRect$4: function($receiver, $0, $1, $2, $3) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("strokeRect", "strokeRect$4", 0, [$0, $1, $2, $3], []));
  },
...
Uri: {"": "Object;_liblib4$_port@,_path@,scheme<,userInfo<,host>,query>,fragment<,_pathSegments@,_queryParameters@",
  ...
  _writeAuthority$1: function(ss) {
    ...
    if (!$.$eq(this._liblib4$_port, 0)) {
      ss._contents = ss._contents + ":";
      str = $.toString$0(this._liblib4$_port);
      str = typeof str === "string" ? str : $.S(str);
      ss._contents = ss._contents + str;
    }
  },
  ...
  $eq: function(_, other) {
    ...
    if (typeof other !== "object" || other === null || !$.getInterceptor(other).$isUri)
      return false;
    return $.$eq(this.scheme, other.scheme) && $.$eq(this.userInfo, other.userInfo) && $.$eq(this.host, other.host) && $.$eq(this._liblib4$_port, other._liblib4$_port) && $.$eq(this._path, other._path) && $.$eq(this.query, other.query) && $.$eq(this.fragment, other.fragment);
  },
  "+==:1:0": 0,
  get$hashCode: function(_) {
...
Interceptor_ListMixin: {"": "Interceptor+ListMixin;", $isList: true, $asList: function() { return [$.File]; }, $isIterable: true, $asIterable: function() { return [$.File]; }},

Interceptor_ListMixin_ImmutableListMixin: {"": "Interceptor_ListMixin+ImmutableListMixin;", $isList: true, $asList: function() { return [$.File]; }, $isIterable: true, $asIterable: function() { return [$.File]; }},
...
_WrappedIterator: {"": "Object;_liblib3$_iterator@",
  ...
  "+moveNext:0:0": 0,
  get$current: function() {
    return this._liblib3$_iterator._liblib3$_current;
  },
  "+current": 0
},
...
_ListRangeIteratorImpl: {"": "Object;_liblib12$_source<,_liblib12$_offset@,_liblib12$_end<",
  ...
  "+current": 0,
  moveNext$0: function() {
    var t1 = this._liblib12$_offset + 1;
    this._liblib12$_offset = t1;
    return t1 < this._liblib12$_end;
  },
  "+moveNext:0:0": 0
},
...
codepointsToUtf8: function(codepoints, offset, $length) {
  ...
  t5 = t4._liblib12$_end;
  t6 = t4._liblib12$_source;
  encodedLength = 0;
  for (; t7 = t4._liblib12$_offset + 1, t4._liblib12$_offset = t7, t7 < t5;) {
    t7 = t4._liblib12$_offset;
    if (t7 !== (t7 | 0))
  ...
  for (t1 = new $._ListRangeIteratorImpl(t1, t2, t3), t2 = t1._liblib12$_end, t3 = t1._liblib12$_source, t4 = encoded.length, insertAt = 0; t5 = t1._liblib12$_offset + 1, t1._liblib12$_offset = t5, t5 < t2;) {
    ...
    default:
      L0:
        while (true)
          switch (state0) {
            case 0:
              t7 = t4._liblib12$_offset + 1;
              t4._liblib12$_offset = t7;
              if (!(t7 < t5))
                break L0;
              t7 = t4._liblib12$_offset;
            case 1:
...
["index_html", "index.html.dart", , {
init_autogenerated: function() {
  var __root, __t, t1, __e0, t2, t3, t4, t5, t6, $arguments, t7;
  ...
  if (1 >= t1.length)
    throw $.ioore(1);
  __e0 = t1[1];
  t1 = new $.Tile2atlasApp(null, null, null, null, null, null, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])));
  t2 = $.get$app();
  t3 = $._activeObserver;
  if (t3 != null)
    t3._addRead$3(t2, 1, "tileset");
  t2 = $.get$onLoad$x(t2.__$tileset.image);
  t3 = t1.get$_onTilesetLoad();
  t4 = t2._target;
  t5 = t2._eventType;
  t6 = t2._useCapture;
  ...
  t1.set$host(t1, __e0);
  __t.children.push(new $.ComponentItem(t1));
  __t.create$0();
  __t.insert$0(__t);
}}],
...
_serialize: function(message) {
  ...
  if (message == null)
    ...
    if (t1)
      ...
      return ["objref", id, new $._LocalSendPortSync($.get$_proxiedObjectTable()._liblib14$_port)];
    }
  }
},
...
LinkedListNode: {"": "Object;_liblib9$_previous@,_liblib9$_next@,_list@,_liblib9$_value@",
  get$next: function() {
  ...
  remove$0: function(_) {
    ...
    if (t1 == null)
      return;
    t1.set$_liblib9$_length($.$sub$n(t1.get$_liblib9$_length(), 1));
    ...
    if (t1 != null)
      ...
      this._list.set$_liblib9$_tail(t2);
...
LinkedList: {"": "IterableBase;_head@,_liblib9$_tail@,_liblib9$_length@",
  get$length: function(_) {
  ...
  add$1: function(_, e) {
    ...
    t1 = node._list;
    if (t1 != null)
      t1.set$_liblib9$_length($.$add$ns(t1.get$_liblib9$_length(), 1));
...
LinkedListIterator: {"": "Object;_copy@,_list@,_liblib9$_current@,_pos@",
  get$current: function() {
  ...
  LinkedListIterator$1: function(_list) {
    var t1, node, i, i0;
    t1 = $.List_List(this._list._liblib9$_length, $.LinkedListNode);
...
Unstable: {"": "Object;"}}],
["model", "src/model.dart", , {
ViewEnum: {"": "Object;_value<",
  toString$0: function(_) {
    return "ViewEnum." + this._value;
  },
  "+toString:0:0": 0
},

TilesetModel: {"": "Observable;image<,__$tileWidth@,__$tileHeight@,$$_observers,$$_changes,hashCode",
  "@": function() {
    return [$.C__ObservableAnnotation];
  },
  set$tileWidth: function(value) {
    ...
    if (t1 != null) {
      ...
      t1 = false;
    if (t1)
      $.notifyChange(this, 1, "tileWidth", this.__$tileWidth, value);
    this.__$tileWidth = value;
  },
  "+tileWidth=": 0,
  set$tileHeight: function(value) {
    var t1 = this.$$_observers;
    if (t1 != null) {
      t1.get$head;
      t1 = t1._head != null;
      ...
      t1 = false;
    if (t1)
      $.notifyChange(this, 1, "tileHeight", this.__$tileHeight, value);
    this.__$tileHeight = value;
  },
  "+tileHeight=": 0
},

AppModel: {"": "Observable;__$titre@,__$currentView@,__$tileset@,__$textureAtlas@,$$_observers,$$_changes,hashCode",
  "@": function() {
    return [$.C__ObservableAnnotation];
  },
  get$titre: function() {
    ...
    if (t1 != null)
      t1._addRead$3(this, 1, "titre");
    return this.__$titre;
  },
  "+titre": 0,
  set$titre: function(value) {
    var t1 = this.$$_observers;
    if (t1 != null) {
      t1.get$head;
      t1 = t1._head != null;
      ...
      t1 = false;
    if (t1)
      $.notifyChange(this, 1, "titre", this.__$titre, value);
    this.__$titre = value;
  },
  "+titre=": 0
}}],
...
["textureatlas", "../src/textureatlas/textureatlas.dart", , {
Frame: {"": "Rectangle;x*,y*,w,h",
  toJson$0: function() {
    return $.makeLiteralMap(["x", this.x, "y", this.y, "w", this.w, "h", this.h]);
  },
  "+toJson:0:0": 0
},

Rectangle: {"": "Object;w@,h@",
  toJson$0: function() {
    return $.makeLiteralMap(["w", this.w, "h", this.h]);
  },
  "+toJson:0:0": 0
},

TextureFrame: {"": "Object;filename*,frame@,rotated@,trimmed@,spriteSourceSize@,sourceSize@",
  toJson$0: function() {
    var t1, t2, t3, t4, t5;
    t1 = this.frame;
    t1 = $.makeLiteralMap(["x", t1.x, "y", t1.y, "w", t1.w, "h", t1.h]);
    t2 = this.rotated;
    t3 = this.trimmed;
    t4 = this.spriteSourceSize;
    t4 = $.makeLiteralMap(["x", t4.x, "y", t4.y, "w", t4.w, "h", t4.h]);
    t5 = this.sourceSize;
    return $.makeLiteralMap(["filename", this.filename, "frame", t1, "rotated", t2, "trimmed", t3, "spriteSourceSize", t4, "sourceSize", $.makeLiteralMap(["w", t5.w, "h", t5.h])]);
  },
  "+toJson:0:0": 0,
  TextureFrame$fromTileSet$5: function(filename, x, y, w, h) {
    this.frame = new $.Frame(x, y, w, h);
    this.rotated = false;
    this.trimmed = false;
    this.spriteSourceSize = new $.Frame(0, 0, w, h);
    this.sourceSize = new $.Rectangle(w, h);
  }
},

TextureAtlas: {"": "Object;frames@",
  toJson$0: function() {
    var jso, t1;
    jso = [];
    t1 = this.frames;
    t1.forEach$1;
    $.IterableMixinWorkaround_forEach(t1, new $.TextureAtlas_toJson_closure(jso));
    return $.makeLiteralMap(["frames", jso]);
  },
  "+toJson:0:0": 0,
  TextureAtlas$fromTileset$3: function(sourceImage, tileHeight, tileWidth) {
    var t1, number, tileY, t2, tileX;
    if (typeof tileHeight !== "number")
      return this.TextureAtlas$fromTileset$3$bailout(1, sourceImage, tileHeight, tileWidth);
    if (typeof tileWidth !== "number")
      return this.TextureAtlas$fromTileset$3$bailout(1, sourceImage, tileHeight, tileWidth);
    t1 = $.getInterceptor$x(sourceImage);
    if ($.$gt$n(t1.get$height(sourceImage), tileHeight) === true && $.$mod$n(t1.get$height(sourceImage), tileHeight) === 0 && $.$gt$n(t1.get$width(sourceImage), tileWidth) === true && $.$mod$n(t1.get$width(sourceImage), tileWidth) === 0) {
      this.frames = [];
      number = 1;
      tileY = 0;
      while (true) {
        t2 = t1.get$height(sourceImage);
        if (typeof t2 !== "number")
          throw $.iae(t2);
        if (!(tileY < t2))
          break;
        tileX = 0;
        while (true) {
          t2 = t1.get$width(sourceImage);
          if (typeof t2 !== "number")
            throw $.iae(t2);
          if (!(tileX < t2))
            break;
          this.frames.push($.TextureFrame$fromTileSet($.JSInt_methods.toString$0(number), tileX, tileY, tileWidth, tileHeight));
          ++number;
          tileX += tileWidth;
        }
        tileY += tileHeight;
      ...
      throw $.wrapException(new $._ExceptionImplementation("Les tailles de l'image et d'un tile ne sont pas compatibles"));
  },
  TextureAtlas$fromTileset$3$bailout: function(state0, sourceImage, tileHeight, tileWidth) {
    var t1, number, tileY, t2, tileX;
    t1 = $.getInterceptor$x(sourceImage);
    if ($.$gt$n(t1.get$height(sourceImage), tileHeight) === true && $.$mod$n(t1.get$height(sourceImage), tileHeight) === 0 && $.$gt$n(t1.get$width(sourceImage), tileWidth) === true && $.$mod$n(t1.get$width(sourceImage), tileWidth) === 0) {
      this.frames = [];
...
TextureAtlas_toJson_closure: {"": "Closure;jso_0",
  call$1: function(frame) {
    this.jso_0.push(frame.toJson$0());
  },
  "+call:1:0": 0,
  $isFunction: true
},

TextureFrame$fromTileSet: function(filename, x, y, w, h) {
  var t1 = new $.TextureFrame(filename, null, null, null, null, null);
  t1.TextureFrame$fromTileSet$5(filename, x, y, w, h);
  return t1;
},

TextureAtlas$fromTileset: function(sourceImage, tileHeight, tileWidth) {
  var t1 = new $.TextureAtlas(null);
  t1.TextureAtlas$fromTileset$3(sourceImage, tileHeight, tileWidth);
  return t1;
}}],
["tile2atlas_app", "app.dart", , {
Tile2atlasApp: {"": "WebComponent;_css@,__e1@,__e3@,__e5@,__e7@,__t@,_host,_shadowRoots,_generatedRoots,_mapper",
  created_autogenerated$0: function() {
    var root, t1, t2, t3;
    root = this._createShadowRoot$0();
    t1 = this._generatedRoots;
    t1.$indexSet(t1, "tile2atlas-app", root);
    this._mapper = new $.ScopedCssMapper($.makeLiteralMap(["tile2atlas-app", "[is=\"tile2atlas-app\"]"]));
    this._css = this._mapper;
    this.__t = new $.Template(root, [], []);
    t1 = $.getInterceptor$x(root);
    $.add$1$ax(t1.get$nodes(root), $.clone$1$x($.get$Tile2atlasApp___shadowTemplate(), true));
    this.__e1 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(root), 1)), 1)), 1);
    t2 = this.__t;
    t2.oneWayBind$4;
    t2.children.push(new $.DomPropertyBinding(new $.Tile2atlasApp_created_autogenerated_closure(this), new $.Tile2atlasApp_created_autogenerated_closure0(), false, false, null));
    t2 = this.__t;
    t3 = new $.NavBar(null, null, null, null, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])));
    t3.set$host(t3, this.__e1);
    t2.component$1;
    t2.children.push(new $.ComponentItem(t3));
    this.__e3 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(root), 1)), 3)), 1);
    t3 = this.__t;
    t2 = this.__e3;
    t3.conditional$3;
    t3.children.push(new $.ConditionalTemplate(false, new $.Tile2atlasApp_created_autogenerated_closure1(), new $.Tile2atlasApp_created_autogenerated_closure2(), null, t2, [], []));
    this.__e5 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(root), 1)), 3)), 3);
    t2 = this.__t;
    t3 = this.__e5;
    t2.conditional$3;
    t2.children.push(new $.ConditionalTemplate(false, new $.Tile2atlasApp_created_autogenerated_closure3(), new $.Tile2atlasApp_created_autogenerated_closure4(), null, t3, [], []));
    this.__e7 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(root), 1)), 3)), 5);
    t1 = this.__t;
    t3 = this.__e7;
    t1.conditional$3;
    t1.children.push(new $.ConditionalTemplate(false, new $.Tile2atlasApp_created_autogenerated_closure5(), new $.Tile2atlasApp_created_autogenerated_closure6(), null, t3, [], []));
    this.__t.create$0();
  },
  ...
  _onTilesetLoad$1: function(e) {
    ...
    if (t2 != null) {
      ...
      t2 = false;
    if (t2)
      $.notifyChange(t1, 1, "currentView", t1.__$currentView, $.ViewEnum_conf);
    t1.__$currentView = $.ViewEnum_conf;
  },
  "+_onTilesetLoad:1:0": 0,
  get$_onTilesetLoad: function() {
    return new $.BoundClosure$1(this, "_onTilesetLoad$1", null);
  }
},

Tile2atlasApp_created_autogenerated_closure0: {"": "Closure;",
  call$0: function() {
    var t1, t2;
    t1 = $.get$app();
    t2 = $._activeObserver;
    if (t2 != null)
      t2._addRead$3(t1, 1, "titre");
    return t1.__$titre;
  },
  "+call:0:0": 0,
  $isFunction: true,
...
Tile2atlasApp_created_autogenerated_closure: {"": "Closure;this_0",
  call$1: function(e) {
    var t1 = this.this_0;
    if (!$.$eq($.get$xtag$x(t1.get$__e1()).get$titre(), e))
      $.get$xtag$x(t1.get$__e1()).set$titre(e);
  },
  "+call:1:0": 0,
  $isFunction: true
},

Tile2atlasApp_created_autogenerated_closure2: {"": "Closure;",
  call$0: function() {
    var t1, t2;
    t1 = $.get$app();
    t2 = $._activeObserver;
    ...
    return t1.__$currentView === $.ViewEnum_choose;
  },
  "+call:0:0": 0,
  $isFunction: true,
  $is_AsyncCallback: true
...
Tile2atlasApp_created_autogenerated_closure1: {"": "Closure;",
  call$1: function(__t) {
    var __e2, t1, t2, t3, t4, t5, t6, $arguments, t7;
    __e2 = $.clone$1$x($.get$Tile2atlasApp___html1(), true);
    t1 = new $.TilesetChoose(null, null, null, null, null, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])));
    t1._reader = new FileReader();
    t2 = $._EventStream$(t1._reader, $.EventStreamProvider_load._eventType, false, null);
    t3 = t1.get$_onReaderComplete();
    t4 = t2._target;
    t5 = t2._eventType;
    t6 = t2._useCapture;
    $arguments = $.substitute(t2.$as_EventStream, $.getRuntimeTypeInfo(t2));
...
Tile2atlasApp_created_autogenerated_closure4: {"": "Closure;",
  call$0: function() {
    var t1, t2;
    t1 = $.get$app();
    t2 = $._activeObserver;
    if (t2 != null)
      t2._addRead$3(t1, 1, "currentView");
    return t1.__$currentView === $.ViewEnum_conf;
  },
  "+call:0:0": 0,
  $isFunction: true,
  $is_AsyncCallback: true
...
Tile2atlasApp_created_autogenerated_closure3: {"": "Closure;",
  call$1: function(__t) {
    var __e4, t1;
    __e4 = $.clone$1$x($.get$Tile2atlasApp___html2(), true);
    t1 = new $.TilesetConfigure(null, null, null, null, null, null, null, null, null, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])));
    t1.set$host(t1, __e4);
    __t.component$1(t1);
...
Tile2atlasApp_created_autogenerated_closure6: {"": "Closure;",
  call$0: function() {
    var t1, t2;
    t1 = $.get$app();
    t2 = $._activeObserver;
    if (t2 != null)
      t2._addRead$3(t1, 1, "currentView");
    return t1.__$currentView === $.ViewEnum_export;
  },
  "+call:0:0": 0,
  $isFunction: true,
  $is_AsyncCallback: true
...
Tile2atlasApp_created_autogenerated_closure5: {"": "Closure;",
  call$1: function(__t) {
    var __e6, t1, t2, t3, output;
    __e6 = $.clone$1$x($.get$Tile2atlasApp___html3(), true);
    t1 = $.$add$ns($.Observable_$_nextHashCode, 1);
    $.Observable_$_nextHashCode = t1;
    t1 = new $.TilesetExport(null, null, null, null, null, null, null, t1, null, null, $.makeLiteralMap([]), new $.ScopedCssMapper($.makeLiteralMap([])));
    t2 = $.get$app();
    t3 = $._activeObserver;
    if (t3 != null)
      t3._addRead$3(t2, 1, "textureAtlas");
    t2 = t2.__$textureAtlas;
    output = $.StringBuffer$("");
    $._JsonStringifier$(output).stringifyValue$1(t2);
    t2 = output.toString$0(output);
    t3 = t1.get$$$_observers();
    if (t3 != null && t3.get$head(t3) != null)
      $.notifyChange(t1, 1, "jso", t1.__$jso, t2);
    t1.__$jso = t2;
    t1.set$host(t1, __e6);
    __t.component$1(t1);
...
["tileset", "../src/tileset/TileSet.dart", , {
TilesetPreview: {"": "Object;_renderer@",
  preview$3$drawGrid$gridStyle: function(renderArea, drawGrid, gridStyle) {
    var t1, context, t2, truncated, t3, tileNumber, i, j, aX, t4, aY;
    t1 = $.getInterceptor$x(renderArea);
    context = t1.get$context2D(renderArea);
    t2 = this._renderer;
    t2 = $.$div$n($.get$width$x(t2.image), t2.tileWidth);
    t2.toInt$0;
    if (isNaN(t2))
      $.throwExpression(new $.UnsupportedError("NaN"));
    ...
    t3 = this._renderer.tileWidth;
    if (typeof t3 !== "number")
      throw $.iae(t3);
    t1.set$width(renderArea, t2 * t3);
    t3 = this._renderer;
    t3 = $.$div$n($.get$height$x(t3.image), t3.tileHeight);
    t3.toInt$0;
    if (isNaN(t3))
      $.throwExpression(new $.UnsupportedError("NaN"));
    ...
    t2 = truncated == -0.0 ? 0 : truncated;
    t3 = this._renderer.tileHeight;
    if (typeof t3 !== "number")
      throw $.iae(t3);
    t1.set$height(renderArea, t2 * t3);
    t3 = $.getInterceptor$x(context);
    t3.set$strokeStyle(context, gridStyle);
    t3.clearRect$4(context, 0, 0, t1.get$width(renderArea), t1.get$height(renderArea));
    tileNumber = 1;
    i = 0;
    while (true) {
      t1 = this._renderer;
      t1 = $.$div$n($.get$height$x(t1.image), t1.tileHeight);
      t1.toInt$0;
      if (isNaN(t1))
        $.throwExpression(new $.UnsupportedError("NaN"));
      if (t1 == Infinity || t1 == -Infinity)
      ...
      if (t1 == null)
        throw t1.$lt();
      truncated = t1 < 0 ? Math.ceil(t1) : Math.floor(t1);
      if (!(i < (truncated == -0.0 ? 0 : truncated)))
        break;
      j = 0;
      while (true) {
        t1 = this._renderer;
        t1 = $.$div$n($.get$width$x(t1.image), t1.tileWidth);
        t1.toInt$0;
        if (isNaN(t1))
          $.throwExpression(new $.UnsupportedError("NaN"));
        if (t1 == Infinity || t1 == -Infinity)
        ...
        if (t1 == null)
          throw t1.$lt();
        truncated = t1 < 0 ? Math.ceil(t1) : Math.floor(t1);
        if (!(j < (truncated == -0.0 ? 0 : truncated)))
          break;
        t1 = this._renderer;
        t2 = t1.tileWidth;
        if (typeof t2 !== "number")
        ...
        if (typeof t4 !== "number")
          throw $.iae(t4);
        aY = i * t4;
        t1.drawTile$4(tileNumber, context, aX, aY);
        t3.strokeRect$4(context, aX, aY, aX + t2, aY + t4);
        ++tileNumber;
        ++j;
      }
      ++i;
  ...
  "+preview:1:2": 0,
  set$tileWidth: function(value) {
    this._renderer.tileWidth = value;
    return value;
  },
  "+tileWidth=": 0,
  set$tileHeight: function(value) {
    this._renderer.tileHeight = value;
    return value;
  },
  "+tileHeight=": 0
},

TilesetRenderer: {"": "Object;image@,tileWidth@,tileHeight@",
  drawTile$4: function(n, context, x, y) {
    var t1, t2, t3, t4, truncated, xSourceTile, ySourceTile;
    t1 = this.image;
    t2 = $.getInterceptor$x(t1);
    t3 = t2.get$width(t1);
    if (t3 !== (t3 | 0))
      return this.drawTile$4$bailout(1, n, context, x, y, t2, t3, t1);
    t4 = this.tileWidth;
    if (typeof t4 !== "number")
      return this.drawTile$4$bailout(2, n, context, x, y, t2, t3, t1, t4);
    t4 = t3 / t4;
    if (isNaN(t4))
      $.throwExpression(new $.UnsupportedError("NaN"));
    ...
    xSourceTile = $.JSInt_methods.$mod(n, truncated == -0.0 ? 0 : truncated);
    if (xSourceTile === 0) {
      t3 = t2.get$width(t1);
      if (t3 !== (t3 | 0))
        return this.drawTile$4$bailout(3, n, context, x, y, t2, t3, t1);
      t4 = this.tileWidth;
      if (typeof t4 !== "number")
        return this.drawTile$4$bailout(4, n, context, x, y, t2, t3, t1, t4);
      t4 = t3 / t4;
      if (isNaN(t4))
        $.throwExpression(new $.UnsupportedError("NaN"));
      if (t4 == Infinity || t4 == -Infinity)
        $.throwExpression(new $.UnsupportedError("Infinity"));
      truncated = t4 < 0 ? Math.ceil(t4) : Math.floor(t4);
      xSourceTile = truncated == -0.0 ? 0 : truncated;
    }
    t2 = t2.get$width(t1);
    if (t2 !== (t2 | 0))
      return this.drawTile$4$bailout(5, n, context, x, y, t2, 0, t1, 0, xSourceTile);
    t3 = this.tileWidth;
    if (typeof t3 !== "number")
      return this.drawTile$4$bailout(6, n, context, x, y, t2, t3, t1, 0, xSourceTile);
    t3 = t2 / t3;
    if (isNaN(t3))
      $.throwExpression(new $.UnsupportedError("NaN"));
    if (t3 == Infinity || t3 == -Infinity)
      $.throwExpression(new $.UnsupportedError("Infinity"));
    truncated = t3 < 0 ? Math.ceil(t3) : Math.floor(t3);
    t2 = Math.ceil(n / (truncated == -0.0 ? 0 : truncated));
    if (isNaN(t2))
      $.throwExpression(new $.UnsupportedError("NaN"));
    if (t2 == Infinity || t2 == -Infinity)
      $.throwExpression(new $.UnsupportedError("Infinity"));
    truncated = t2 < 0 ? Math.ceil(t2) : Math.floor(t2);
    ySourceTile = truncated == -0.0 ? 0 : truncated;
    t2 = this.tileWidth;
    if (typeof t2 !== "number")
      throw $.iae(t2);
    t3 = this.tileHeight;
    if (typeof t3 !== "number")
      throw $.iae(t3);
    $.drawImageScaledFromSource$9$x(context, t1, (xSourceTile - 1) * t2, (ySourceTile - 1) * t3, t2, t3, x, y, t2, t3);
  },
  "+drawTile:4:0": 0,
  drawTile$4$bailout: function(state0, n, context, x, y, t2, t3, t1, t4, xSourceTile) {
    switch (state0) {
      case 0:
        t1 = this.image;
        t2 = $.getInterceptor$x(t1);
      ...
      case 2:
        ...
        xSourceTile = $.JSInt_methods.$mod(n, truncated == -0.0 ? 0 : truncated);
      default:
        if (state0 === 4 || state0 === 3 || state0 === 0 && xSourceTile === 0)
          switch (state0) {
            case 0:
              t3 = t2.get$width(t1);
            case 3:
  ...
  get$_xTileCount: function() {
    return $.$div$n($.get$width$x(this.image), this.tileWidth);
  },
  "+_xTileCount": 0,
  get$_yTileCount: function() {
    return $.$div$n($.get$height$x(this.image), this.tileHeight);
  },
  "+_yTileCount": 0
}}],
...
dispatch: function() {
  ...
  do {
    for (t1 = $._watchers, t1.get$iterator, t1 = $.LinkedListIterator$(t1), dirty = false; t1.moveNext$0();)
      if (t1._liblib9$_current.compareAndNotify$0() === true)
        dirty = true;
    if (dirty) {
      ++total;
      t1 = total < 10;
...
["x_nav_bar", "navbar.html.dart", , {
NavBar: {"": "WebComponent;_liblib8$_css@,__e9@,_liblib8$__t@,titre@,_host,_shadowRoots,_generatedRoots,_mapper",
  created_autogenerated$0: function() {
    var root, t1, __binding8;
    root = this._createShadowRoot$0();
    t1 = this._generatedRoots;
    t1.$indexSet(t1, "x-nav-bar", root);
    this._mapper = new $.ScopedCssMapper($.makeLiteralMap(["x-nav-bar", "[is=\"x-nav-bar\"]"]));
    this._liblib8$_css = this._mapper;
    this._liblib8$__t = new $.Template(root, [], []);
    t1 = $.getInterceptor$x(root);
    $.add$1$ax(t1.get$nodes(root), $.clone$1$x($.get$NavBar___shadowTemplate(), true));
    this.__e9 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(root), 1)), 1)), 1)), 1);
    __binding8 = this._liblib8$__t.contentBind$2(new $.NavBar_created_autogenerated_closure(this), false);
    $.add$1$ax($.get$nodes$x(this.__e9), __binding8);
...
NavBar_created_autogenerated_closure: {"": "Closure;this_0",
  call$0: function() {
    return this.this_0.get$titre();
  },
  "+call:0:0": 0,
  $isFunction: true,
  $is_AsyncCallback: true
}}],
["x_tileset_choose", "tileset-choose.dart", , {
TilesetChoose: {"": "WebComponent;_liblib7$_css@,__e10@,_liblib7$__t@,_chooser@,_reader@,_host,_shadowRoots,_generatedRoots,_mapper",
  created_autogenerated$0: function() {
    var root, t1;
    root = this._createShadowRoot$0();
    t1 = this._generatedRoots;
    t1.$indexSet(t1, "x-tileset-choose", root);
    this._mapper = new $.ScopedCssMapper($.makeLiteralMap(["x-tileset-choose", "[is=\"x-tileset-choose\"]"]));
    this._liblib7$_css = this._mapper;
    this._liblib7$__t = new $.Template(root, [], []);
    t1 = $.getInterceptor$x(root);
    $.add$1$ax(t1.get$nodes(root), $.clone$1$x($.get$TilesetChoose___shadowTemplate(), true));
    this.__e10 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(root), 1)), 5)), 1);
    this._liblib7$__t.listen$2($.get$onChange$x(this.__e10), new $.TilesetChoose_created_autogenerated_closure(this));
    this._liblib7$__t.create$0();
  },
  "+created_autogenerated:0:0": 0,
  inserted_autogenerated$0: function() {
    var t1 = this._liblib7$__t;
    t1.insert$0(t1);
  },
  "+inserted_autogenerated:0:0": 0,
  removed_autogenerated$0: function() {
  ...
  inserted$0: function() {
    ...
    if (t1 == null)
      $.throwExpression(new $.StateError("host element has not been set."));
    this._chooser = $.query$1$x(t1, "#tileset-chooser");
  },
  "+inserted:0:0": 0,
  _onReaderComplete$1: function($event) {
    var t1, t2;
    t1 = $.get$app();
    t2 = $._activeObserver;
    if (t2 != null)
      t2._addRead$3(t1, 1, "tileset");
    $.set$src$x(t1.__$tileset.image, this._reader.result);
  },
  "+_onReaderComplete:1:0": 0,
  get$_onReaderComplete: function() {
    return new $.BoundClosure$1(this, "_onReaderComplete$1", null);
  }
},

TilesetChoose_created_autogenerated_closure: {"": "Closure;this_0",
  call$1: function($$event) {
    var t1 = this.this_0;
    if ($.$gt$n($.get$length$asx($.get$files$x(t1.get$_chooser())), 0) === true)
      $.readAsDataUrl$1$x(t1.get$_reader(), $.$index$asx($.get$files$x(t1.get$_chooser()), 0));
  },
  "+call:1:0": 0,
  $isFunction: true
}}],
["x_tileset_configure", "tileset-configure.dart", , {
TilesetConfigure: {"": "WebComponent;_liblib6$_css@,__e13@,__e15@,__e17@,__e11@,__e12@,_liblib6$__t@,_tilesetPreview@,tilesetArea@,_host,_shadowRoots,_generatedRoots,_mapper",
  created_autogenerated$0: function() {
    var root, t1, t2, __binding14, __binding16;
    root = this._createShadowRoot$0();
    t1 = this._generatedRoots;
    t1.$indexSet(t1, "x-tileset-configure", root);
    this._mapper = new $.ScopedCssMapper($.makeLiteralMap([".inline", "inline", ".form-inline", "form-inline", "#tileset-area", "tileset-area", "x-tileset-configure", "[is=\"x-tileset-configure\"]"]));
    this._liblib6$_css = this._mapper;
    this._liblib6$__t = new $.Template(root, [], []);
    t1 = $.getInterceptor$x(root);
    $.add$1$ax(t1.get$nodes(root), $.clone$1$x($.get$TilesetConfigure___shadowTemplate(), true));
    this.__e11 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(root), 5)), 1)), 5)), 3);
    this._liblib6$__t.listen$2($.get$onChange$x(this.__e11), new $.TilesetConfigure_created_autogenerated_closure(this));
    this._liblib6$__t.listen$2($.get$onInput$x(this.__e11), new $.TilesetConfigure_created_autogenerated_closure0(this));
    t2 = this._liblib6$__t;
    t2.oneWayBind$4;
    t2.children.push(new $.DomPropertyBinding(new $.TilesetConfigure_created_autogenerated_closure1(this), new $.TilesetConfigure_created_autogenerated_closure2(this), false, false, null));
    this.__e12 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(root), 5)), 1)), 7)), 3);
    this._liblib6$__t.listen$2($.get$onChange$x(this.__e12), new $.TilesetConfigure_created_autogenerated_closure3(this));
    this._liblib6$__t.listen$2($.get$onInput$x(this.__e12), new $.TilesetConfigure_created_autogenerated_closure4(this));
    t2 = this._liblib6$__t;
    t2.oneWayBind$4;
    t2.children.push(new $.DomPropertyBinding(new $.TilesetConfigure_created_autogenerated_closure5(this), new $.TilesetConfigure_created_autogenerated_closure6(this), false, false, null));
    this.__e13 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(root), 5)), 1)), 9);
    this._liblib6$__t.listen$2($.get$onClick$x(this.__e13), new $.TilesetConfigure_created_autogenerated_closure7(this));
    this.__e15 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(root), 5)), 3)), 3);
    __binding14 = this._liblib6$__t.contentBind$2(new $.TilesetConfigure_created_autogenerated_closure8(), false);
    $.addAll$1$ax($.get$nodes$x(this.__e15), [document.createTextNode("height: "), __binding14]);
    this.__e17 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(root), 5)), 3)), 5);
    __binding16 = this._liblib6$__t.contentBind$2(new $.TilesetConfigure_created_autogenerated_closure9(), false);
    $.addAll$1$ax($.get$nodes$x(this.__e17), [document.createTextNode("Width: "), __binding16]);
    this._liblib6$__t.create$0();
  },
  "+created_autogenerated:0:0": 0,
  inserted_autogenerated$0: function() {
    var t1 = this._liblib6$__t;
    t1.insert$0(t1);
  },
  "+inserted_autogenerated:0:0": 0,
  removed_autogenerated$0: function() {
  ...
  set$tileWidth: function(value) {
    ...
    if (t2 != null)
      t2._addRead$3(t1, 1, "tileset");
    t1 = t1.__$tileset;
    t2 = $.Primitives_parseInt(value, null, new $.TilesetConfigure_tileWidth_closure());
    t3 = t1.$$_observers;
    if (t3 != null) {
      t3.get$head;
      t3 = t3._head != null;
      ...
      t3 = false;
    if (t3)
      $.notifyChange(t1, 1, "tileWidth", t1.__$tileWidth, t2);
    t1.__$tileWidth = t2;
    return t2;
  },
  "+tileWidth=": 0,
  set$tileHeight: function(value) {
    ...
    if (t2 != null)
      t2._addRead$3(t1, 1, "tileset");
    t1 = t1.__$tileset;
    t2 = $.Primitives_parseInt(value, null, new $.TilesetConfigure_tileHeight_closure());
    t3 = t1.$$_observers;
    if (t3 != null) {
      t3.get$head;
      t3 = t3._head != null;
      ...
      t3 = false;
    if (t3)
      $.notifyChange(t1, 1, "tileHeight", t1.__$tileHeight, t2);
    t1.__$tileHeight = t2;
    return t2;
  },
  "+tileHeight=": 0,
  inserted$0: function() {
    ...
    if (t1 == null)
      $.throwExpression(new $.StateError("host element has not been set."));
    this.tilesetArea = $.query$1$x(t1, "#tileset-area");
    t1 = $.get$app();
    t2 = $._activeObserver;
    if (t2 != null)
      t2._addRead$3(t1, 1, "tileset");
    ...
    t3 = $._activeObserver;
    if (t3 != null)
      t3._addRead$3(t2, 1, "tileWidth");
    t2 = t2.__$tileWidth;
    t3 = $.get$app();
    t4 = $._activeObserver;
    if (t4 != null)
      t4._addRead$3(t3, 1, "tileset");
    t3 = t3.__$tileset;
    t4 = $._activeObserver;
    if (t4 != null)
      t4._addRead$3(t3, 1, "tileHeight");
    t4 = new $.TilesetPreview(null);
    t3 = new $.TilesetRenderer(t1.__$tileset.image, t2, t3.__$tileHeight);
    t1 = t3.get$_xTileCount();
    if (t1 == null)
      throw t1.$mod();
    if ($.JSNumber_methods.$mod(t1, 1) !== 0)
      $.throwExpression($.Exception_Exception("Le tileset n'a pas une largeur multiple de " + $.S(t3.tileWidth)));
    t1 = t3.get$_yTileCount();
    if (t1 == null)
      throw t1.$mod();
    if ($.JSNumber_methods.$mod(t1, 1) !== 0)
      $.throwExpression($.Exception_Exception("Le tileset n'a pas une hauteur multiple de " + $.S(t3.tileHeight)));
    t4._renderer = t3;
    this._tilesetPreview = t4;
    this._detectDefinition$0();
    this.renderTileset$0();
  },
  "+inserted:0:0": 0,
  renderTileset$0: function() {
    var t1, t2, t3;
    t1 = $.get$app();
    t2 = $._activeObserver;
    if (t2 != null)
      t2._addRead$3(t1, 1, "tileset");
    t1 = $.get$width$x(t1.__$tileset.image);
    t2 = $.get$app();
    t3 = $._activeObserver;
    if (t3 != null)
      t3._addRead$3(t2, 1, "tileset");
    ...
    if (t3 != null)
      t3._addRead$3(t2, 1, "tileWidth");
    if ($.$mod$n(t1, t2.__$tileWidth) === 0) {
      t1 = $.get$app();
      t2 = $._activeObserver;
      if (t2 != null)
        t2._addRead$3(t1, 1, "tileset");
      t1 = $.get$height$x(t1.__$tileset.image);
      t2 = $.get$app();
      t3 = $._activeObserver;
      if (t3 != null)
        t3._addRead$3(t2, 1, "tileset");
      ...
      t3 = $._activeObserver;
      if (t3 != null)
        t3._addRead$3(t2, 1, "tileHeight");
      t1 = $.$mod$n(t1, t2.__$tileHeight) === 0;
    } else
      t1 = false;
    if (t1) {
      t1 = this._tilesetPreview;
      t2 = $.get$app();
      t3 = $._activeObserver;
      if (t3 != null)
        t3._addRead$3(t2, 1, "tileset");
      ...
      t2 = t2.__$tileWidth;
      t1.set$tileWidth;
      t1._renderer.tileWidth = t2;
      t2 = this._tilesetPreview;
      t1 = $.get$app();
      t3 = $._activeObserver;
      if (t3 != null)
        t3._addRead$3(t1, 1, "tileset");
      t1 = t1.__$tileset;
      t3 = $._activeObserver;
      if (t3 != null)
        t3._addRead$3(t1, 1, "tileHeight");
      t1 = t1.__$tileHeight;
      t2.set$tileHeight;
      t2._renderer.tileHeight = t1;
      this._tilesetPreview.preview$3$drawGrid$gridStyle(this.tilesetArea, true, "red");
    }
  },
  "+renderTileset:0:0": 0,
  _detectDefinition$0: function() {
    var t1, tileDefinition, def, t2, t3;
    for (t1 = [128, 64, 32, 16, 8], t1 = new $.ListIterator(t1, t1.length, 0, null); tileDefinition = null, t1.moveNext$0();) {
      def = t1._current;
      t2 = $.get$app();
      t3 = $._activeObserver;
      if (t3 != null)
        t3._addRead$3(t2, 1, "tileset");
      t2 = t2.__$tileset.image;
      t3 = $.getInterceptor$x(t2);
      if ($.$mod$n(t3.get$height(t2), def) === 0 && $.$mod$n(t3.get$width(t2), def) === 0) {
        tileDefinition = def;
        break;
      }
    }
    if (tileDefinition != null) {
      ...
      if (t2 != null) {
        ...
        t2 = false;
      if (t2)
        $.notifyChange(t1, 1, "tileWidth", t1.__$tileWidth, tileDefinition);
      t1.__$tileWidth = tileDefinition;
      t1 = $.get$app();
      t2 = $._activeObserver;
      if (t2 != null)
        t2._addRead$3(t1, 1, "tileset");
      ...
      if (t2 != null) {
        ...
        t2 = false;
      if (t2)
        $.notifyChange(t1, 1, "tileHeight", t1.__$tileHeight, tileDefinition);
      t1.__$tileHeight = tileDefinition;
    }
  },
  "+_detectDefinition:0:0": 0
},

TilesetConfigure_created_autogenerated_closure: {"": "Closure;this_0",
  call$1: function($$event) {
    this.this_0.renderTileset$0();
  },
  "+call:1:0": 0,
  $isFunction: true
},

TilesetConfigure_created_autogenerated_closure0: {"": "Closure;this_1",
  call$1: function($$event) {
    var t1 = this.this_1;
    t1.set$tileWidth($.get$value$x(t1.get$__e11()));
  },
  "+call:1:0": 0,
  $isFunction: true
},

TilesetConfigure_created_autogenerated_closure2: {"": "Closure;this_2",
  call$0: function() {
    var t1, t2;
    t1 = $.get$app();
    t2 = $._activeObserver;
    ...
    t2 = $._activeObserver;
    if (t2 != null)
      t2._addRead$3(t1, 1, "tileWidth");
    return $.toString$0(t1.__$tileWidth);
  },
  "+call:0:0": 0,
  $isFunction: true,
  $is_AsyncCallback: true
...
TilesetConfigure_created_autogenerated_closure1: {"": "Closure;this_3",
  call$1: function(e) {
    var t1 = this.this_3;
    if (!$.$eq($.get$value$x(t1.get$__e11()), e))
...
TilesetConfigure_created_autogenerated_closure3: {"": "Closure;this_4",
  call$1: function($$event) {
    this.this_4.renderTileset$0();
  },
  "+call:1:0": 0,
  $isFunction: true
},

TilesetConfigure_created_autogenerated_closure4: {"": "Closure;this_5",
  call$1: function($$event) {
    var t1 = this.this_5;
    t1.set$tileHeight($.get$value$x(t1.get$__e12()));
  },
  "+call:1:0": 0,
  $isFunction: true
},

TilesetConfigure_created_autogenerated_closure6: {"": "Closure;this_6",
  call$0: function() {
    var t1, t2;
    t1 = $.get$app();
    t2 = $._activeObserver;
    ...
    t2 = $._activeObserver;
    if (t2 != null)
      t2._addRead$3(t1, 1, "tileHeight");
    return $.toString$0(t1.__$tileHeight);
  },
  "+call:0:0": 0,
  $isFunction: true,
  $is_AsyncCallback: true
...
TilesetConfigure_created_autogenerated_closure5: {"": "Closure;this_7",
  call$1: function(e) {
    var t1 = this.this_7;
    if (!$.$eq($.get$value$x(t1.get$__e12()), e))
...
TilesetConfigure_created_autogenerated_closure7: {"": "Closure;this_8",
  call$1: function($$event) {
    var t1, t2, t3, t4, t5;
    t1 = $.get$app();
    t2 = $.get$app();
    ...
    t5 = $._activeObserver;
    if (t5 != null)
      t5._addRead$3(t4, 1, "tileset");
    t4 = t4.__$tileset;
    t5 = $._activeObserver;
    if (t5 != null)
      t5._addRead$3(t4, 1, "tileWidth");
    t2 = $.TextureAtlas$fromTileset(t2.__$tileset.image, t3, t4.__$tileWidth);
    t3 = t1.$$_observers;
    if (t3 != null) {
      t3.get$head;
      t3 = t3._head != null;
      ...
      t3 = false;
    if (t3)
      $.notifyChange(t1, 1, "textureAtlas", t1.__$textureAtlas, t2);
    t1.__$textureAtlas = t2;
    t1 = $.get$app();
    t2 = t1.$$_observers;
    if (t2 != null) {
      t2.get$head;
      ...
      t2 = false;
    if (t2)
      $.notifyChange(t1, 1, "currentView", t1.__$currentView, $.ViewEnum_export);
    t1.__$currentView = $.ViewEnum_export;
  },
  "+call:1:0": 0,
  $isFunction: true
},

TilesetConfigure_created_autogenerated_closure8: {"": "Closure;",
  call$0: function() {
    var t1, t2;
    t1 = $.get$app();
    t2 = $._activeObserver;
    if (t2 != null)
      t2._addRead$3(t1, 1, "tileset");
    return $.get$height$x(t1.__$tileset.image);
  },
  "+call:0:0": 0,
  $isFunction: true,
  $is_AsyncCallback: true
...
TilesetConfigure_created_autogenerated_closure9: {"": "Closure;",
  call$0: function() {
    var t1, t2;
    t1 = $.get$app();
    t2 = $._activeObserver;
    if (t2 != null)
      t2._addRead$3(t1, 1, "tileset");
    return $.get$width$x(t1.__$tileset.image);
  },
  "+call:0:0": 0,
  $isFunction: true,
  $is_AsyncCallback: true
...
TilesetConfigure_tileWidth_closure: {"": "Closure;",
  call$1: function(v) {
    return 0;
  },
  "+call:1:0": 0,
...
TilesetConfigure_tileHeight_closure: {"": "Closure;",
  call$1: function(v) {
    return 0;
  },
  "+call:1:0": 0,
...
["x_tileset_export", "tileset-export.dart", , {
TilesetExport: {"": "WebComponent_Observable;_liblib$_css@,__e18@,__e20@,_liblib$__t@,__$jso@,$$_observers,$$_changes,hashCode,_host,_shadowRoots,_generatedRoots,_mapper",
  created_autogenerated$0: function() {
    var root, t1, __binding19;
    root = this._createShadowRoot$0();
    t1 = this._generatedRoots;
    t1.$indexSet(t1, "x-tileset-export", root);
    this._mapper = new $.ScopedCssMapper($.makeLiteralMap([".button-bar", "button-bar", "x-tileset-export", "[is=\"x-tileset-export\"]"]));
    this._liblib$_css = this._mapper;
    this._liblib$__t = new $.Template(root, [], []);
    t1 = $.getInterceptor$x(root);
    $.add$1$ax(t1.get$nodes(root), $.clone$1$x($.get$TilesetExport___shadowTemplate(), true));
    this.__e18 = $.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(root), 3)), 1);
    this._liblib$__t.listen$2($.get$onClick$x(this.__e18), new $.TilesetExport_created_autogenerated_closure(this));
    this.__e20 = $.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(root), 5)), 1);
    __binding19 = this._liblib$__t.contentBind$2(new $.TilesetExport_created_autogenerated_closure0(this), false);
    $.add$1$ax($.get$nodes$x(this.__e20), __binding19);
...
TilesetExport_created_autogenerated_closure: {"": "Closure;this_0",
  call$1: function($$event) {
    $._enterScopeIfNeeded();
    $.alert$1$x($._deserialize($._jsPortSync.callSync$1([])), "toto");
  },
  "+call:1:0": 0,
  $isFunction: true
},

TilesetExport_created_autogenerated_closure0: {"": "Closure;this_1",
  call$0: function() {
    var t1, t2;
    t1 = this.this_1;
    t2 = $._activeObserver;
    if (t2 != null)
      t2._addRead$3(t1, 1, "jso");
    return t1.get$__$jso();
  },
  "+call:0:0": 0,
  $isFunction: true,
  $is_AsyncCallback: true
...
$.ViewEnum_export = new $.ViewEnum("export");
...
$.DomName_2No1 = new $.DomName("HTMLOutputElement.defaultValue");
...
$.DomName_2No0 = new $.DomName("FileReader.error");
...
$.DomName_Y6D1 = new $.DomName("Document.oninput");
...
$.DomName_Y6D6 = new $.DomName("Document.createEvent");
...
$.DomName_8aB0 = new $.DomName("HTMLMediaElement.webkitClosedCaptionsVisible");
...
$.DomName_atK = new $.DomName("Element.onload");
...
$.DomName_KPI = new $.DomName("CanvasRenderingContext2D.strokeRect");
...
$.DomName_2No2 = new $.DomName("SVGStyleElement.xmlspace");
...
$.DomName_o2T = new $.DomName("CanvasRenderingContext2D.clearRect");
...
$.DomName_8aB = new $.DomName("HTMLBodyElement.onload");
$.DomName_yHF = new $.DomName("HTMLObjectElement.code");
$.ViewEnum_conf = new $.ViewEnum("conf");
...
$.DomName_8aB2 = new $.DomName("SVGFEImageElement.href");
...
$.ViewEnum_choose = new $.ViewEnum("choose");
...
$.DomName_IMK1 = new $.DomName("SVGViewSpec.zoomAndPan");
...
$.DomName_Y6D5 = new $.DomName("SVGFEOffsetElement.height");
...
$.readAsDataUrl$1$x = function(receiver, a0) {
  return $.getInterceptor$x(receiver).readAsDataUrl$1(receiver, a0);
};
...
Isolate.$lazy($, "app", "app", "get$app", function() {
  ...
  return new $.AppModel("Tile2Atlas", $.ViewEnum_choose, new $.TilesetModel(t1, 32, 32, null, null, t2), null, null, null, t3);
});
Isolate.$lazy($, "__html1", "Tile2atlasApp___html1", "get$Tile2atlasApp___html1", function() {
  return $._ElementFactoryProvider_createElement_html("<div is=\"x-tileset-choose\"></div>");
});
Isolate.$lazy($, "__html2", "Tile2atlasApp___html2", "get$Tile2atlasApp___html2", function() {
  return $._ElementFactoryProvider_createElement_html("<div is=\"x-tileset-configure\"></div>");
});
Isolate.$lazy($, "__html3", "Tile2atlasApp___html3", "get$Tile2atlasApp___html3", function() {
  return $._ElementFactoryProvider_createElement_html("<div is=\"x-tileset-export\"></div>");
});
Isolate.$lazy($, "__shadowTemplate", "Tile2atlasApp___shadowTemplate", "get$Tile2atlasApp___shadowTemplate", function() {
  var fragment = document.createDocumentFragment();
  $.set$innerHtml$x(fragment, "  <section>\n    <header>\n      <div is=\"x-nav-bar\"></div>\n    </header>\n    <section id=\"view\" class=\"container\">\n      <template></template>\n      <template></template>\n      <template></template>\n    </section>\n  </section>\n");
  return fragment;
});
...
function init() {
  ...
  Isolate.$finishClasses = function(collectedClasses, isolateProperties, existingIsolateProperties) {
    ...
    var objectClassObject = collectedClasses.Object, shortNames = "call$0,call$1,call$2,call$3,call$4,call$9,eval$1,fork$0,get$sb,then$1,get$_id,write$1,_splay$1,cancel$0,create$0,get$__e1,get$_key,get$keys,get$left,get$next,listen$1,lookup$1,set$left,set$next,toJson$0,_onData$1,_remove$1,created$0,get$__e11,get$__e12,get$_list,get$_name,get$_next,get$_zone,get$isUrl,get$right,get$titre,perform$1,process$0,removed$0,set$_head,set$_next,set$right,set$titre,_addRead$3,_deliver$0,_onError$1,callSync$1,get$__$jso,get$_state,inserted$0,moveNext$0,runAsync$1,set$_state,traverse$1,visitMap$1,_addError$1,_callback$2,_dispatch$1,_setError$1,_setValue$1,bodySetup$1,component$1,get$_reader,get$current,set$_handle,visitList$1,_runInZone$2,_sendError$1,_sendValue$1,catchError$1,get$_chooser,get$isGetter,get$isSetter,handleNext$1,toSendPort$0,unregister$1,_addNewRoot$2,_setGlobals$0,containsKey$1,createTimer$2,deserialize$1,get$_callback,get$_contents,get$_duration,get$_previous,get$_registry,get$_workerId,get$isVisible,set$_contents,set$_previous,set$isVisible,set$tileWidth,_addListener$1,_runCallback$1,_subscribeTo$1,get$$$_changes,get$_errorZone,get$_isChained,get$_isolateId,get$_scheduled,get$memberName,runIteration$0,set$$$_changes,set$_scheduled,set$tileHeight,_checkReplyTo$1,_liblib5$_add$1,get$_futurePort,renderTileset$0,visitSendPort$1,expectCallback$0,get$$$_observers,get$_chainSource,get$_receivePort,set$$$_observers,visitPrimitive$1,_zonedSendError$1,_zonedSendValue$1,composeChildren$0,executeCallback$1,get$_liblib10$_id,get$_nextListener,inSameErrorZone$1,set$_nextListener,visitCloseToken$1,_distributeNodes$2,_inSameErrorZone$1,_rebuildWorkList$1,compareAndNotify$0,get$_openCallbacks,get$namedArguments,set$_liblib9$_next,set$_liblib9$_tail,set$_openCallbacks,visitIsolateSink$1,_createShadowRoot$0,get$_liblib0$_value,set$_liblib0$_value,visitSendPortSync$1,_liblib3$_callback$1,_liblib3$_dispatch$1,get$_liblib9$_length,set$_liblib9$_length,deserializeSendPort$1,handleUncaughtError$1,get$_resultOrListeners,set$_liblib9$_previous,created_autogenerated$0,deserializeCloseToken$1,get$positionalArguments,removed_autogenerated$0,deserializeIsolateSink$1,executeCallbackGuarded$1,inserted_autogenerated$0,_findLeftMostDescendent$1,_liblib3$_serializeList$1,_liblib3$_deserializeMap$1,_liblib3$_deserializeList$1,cancelCallbackExpectation$0,_liblib3$_deserializeHelper$1,executePeriodicCallbackGuarded$1".split(","), longNames = "call,call,call,call,call,call,eval,fork,sb,then,_id,write,_splay,cancel,create,__e1,_key,keys,left,next,listen,lookup,left=,next=,toJson,_onData,_remove,created,__e11,__e12,_list,_name,_next,_zone,isUrl,right,titre,perform,process,removed,_head=,_next=,right=,titre=,_addRead,_deliver,_onError,callSync,__$jso,_state,inserted,moveNext,runAsync,_state=,traverse,visitMap,_addError,_callback,_dispatch,_setError,_setValue,bodySetup,component,_reader,current,_handle=,visitList,_runInZone,_sendError,_sendValue,catchError,_chooser,isGetter,isSetter,handleNext,toSendPort,unregister,_addNewRoot,_setGlobals,containsKey,createTimer,deserialize,_callback,_contents,_duration,_previous,_registry,_workerId,isVisible,_contents=,_previous=,isVisible=,tileWidth=,_addListener,_runCallback,_subscribeTo,$_changes,_errorZone,_isChained,_isolateId,_scheduled,memberName,runIteration,$_changes=,_scheduled=,tileHeight=,_checkReplyTo,_add,_futurePort,renderTileset,visitSendPort,expectCallback,$_observers,_chainSource,_receivePort,$_observers=,visitPrimitive,_zonedSendError,_zonedSendValue,composeChildren,executeCallback,_id,_nextListener,inSameErrorZone,_nextListener=,visitCloseToken,_distributeNodes,_inSameErrorZone,_rebuildWorkList,compareAndNotify,_openCallbacks,namedArguments,_next=,_tail=,_openCallbacks=,visitIsolateSink,_createShadowRoot,_value,_value=,visitSendPortSync,_callback,_dispatch,_length,_length=,deserializeSendPort,handleUncaughtError,_resultOrListeners,_previous=,created_autogenerated,deserializeCloseToken,positionalArguments,removed_autogenerated,deserializeIsolateSink,executeCallbackGuarded,inserted_autogenerated,_findLeftMostDescendent,_serializeList,_deserializeMap,_deserializeList,cancelCallbackExpectation,_deserializeHelper,executePeriodicCallbackGuarded".split(",");
